    ...
    <div class="playlist-and-albums">
        <div class="container">
            <div class="photo-and-button">
                ...
                <div class="button-and-text secret_key_div">
                    <!-- <div class="edit_profile ">
                        <a href="#" class="profile_edit_button">Редактировать данные</a>
                    </div> -->
                    <div class="div-secret-key">
                        <?php
                        if (!empty($InfoTrack->secret_key)) {
                            echo "<a href=\"php-handler/delete_key.php\">Отключить двухфакторную аудентификацию</a>";
                        } else {
                            echo "<a href=\"php-handler/authenticator.php\">Подключить двухфакторную аудентификацию</a>";
                        }
                        ?>
                    </div>
                </div>

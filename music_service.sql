...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 26 2023 г., 09:23
...
INSERT INTO `users` (`ID_users`, `login`, `email`, `password`, `ID_role`, `secret_key`) VALUES
(1, 'admin', 'isip_a.yu.maslikov@mpt.ru', '12345678', 1, NULL),
(2, 'Сашка', 'sasha_maslikov@inbox.ru', 'ssrcasdwafs', 2, NULL),
(8, 'Alexandr', 'Alexandr@gmail.com', '$2y$10$c1INx75NMlrinKFjzINe0eA/KISLO9bqXHlTHZXePJ5ler1uyV6k6', 2, NULL),
(9, 'test', 'test@test.ru', '$2y$10$ZZB7BCKiW46VZB8l6KzXPe5mLChnwrQz5dlcfTAyeMFRfNdFPOe5m', 1, '6RNUUHCAAXDE57M3'),
(12, 'Maksim', 'Maksim@mail.ru', '$2y$10$FxDbVI4PV1w1UPymzayq1eQ2TMkomBsj9/HrgSN8ecs./UE/dV472', 2, NULL),
(24, 'Kolya', 'Kolya@mail.ru', '$2y$10$K5XU6gB7J4GE0pvHCC3Ja.0WXTiDXEGnPPOKnuWKZtsrVQOJEgPoW', 2, NULL),
(26, 'andruha', 'andruha@mail.ru', '$2y$10$V9GH0x23HnT.iJ7pBeJ6bOivwaXMdGwtLeh1/V0uO9at2LSBSAs1K', 2, NULL),
(27, 'Valera', 'Valera@mail.ru', '$2y$10$.Cdl7aFDQw4HeWQp.hiwL..66ps1AHyN1tUfsW0bu489d.ZPsW9Hm', 2, NULL),
(29, 'Anton', 'Anton@mail.ru', '$2y$10$Z8xtmRVeKrMQcRs.11BcbuAAFBQgmfL7cpvDrFCDmxT2CQj0lG/Mm', 2, NULL),
(30, 'Alena', 'Alena@mail.ru', '$2y$10$Cq3AAh5idh9RALows4/K3.35G73Z1qNsvEwwCfkqgZ3NwHewiB/yG', 2, NULL),
(31, 'Dmitriy', 'Dmitriy@mail.ru', '$2y$10$47tQlQoHWvEZme8.ZOD3oug3YWXDas2CPw1V3B1Y2KxRVjJvvIUkO', 2, NULL),
(32, 'Aleksandr', 'Aleksandr@mail.ru', '$2y$10$JvMUo.9WiHr.CF3g0zVfFeRrxVqYLJsr34wt8/dZkrXC2tOFJeKTa', 2, NULL),
(33, 'testtest', 'testtest@test', '$2y$10$vUqhuMqnmgYddeEmaDjdDeM6gx2Qa.iii.n/sofJJTQKut0OlwIc2', 2, NULL),
(35, 'trest', 'trest@sdsad', '$2y$10$wj52uA32PuBk431EILKNk.oiq3jObaFGsKgxlPNOEG8sBgC67CH46', 2, NULL),
(36, 'mamamama', 'mama@asdasd', '$2y$10$HtEhTxwSgshZ3A4ZlaUZcOFNPtf26BzduL8Vz8JXKoTZ81esJZjei', 2, 'Z2QYKLY6IC4U3YUS'),
(37, 'testtest2', 'testtest@sadsad', '$2y$10$8T9uwNwlvZiQWFMUrIH8j.cAnSrOhouNKm1g7hhkJdYGTmJu2ZOpy', 2, NULL),
(38, 'ilka', 'ilka@ilka.ru', '$2y$10$1ns0JBsVuEKY9/RUgd33peEU.RIfpe581B3eEyh7zXV3pIFc9ZolS', 2, 'DKZPGW7TGWS4PQ3C'),
(39, 'bebra12', 'bebra12@sasas', '$2y$10$IyKcvxrli1xPYt/JoYD9MO2J1sN2Jeon9VQ50ovCHdi6dmAbfuUfK', 2, 'FGA3ZU7UJXMKZ7OU'),
(40, 'isip_a.yu.maslikov', 'isip_a.yu.maslikov@mpt.ru', '$2y$10$M7ObTMDYWDrkOjusM0UQj.UdsmGT7HQ5A2wuaDAO54DFZh13RYSiO', 2, NULL),
(41, 'Санечка', 'isip_a.yu.maslikov@mpt.ru', '$2y$10$VZu1QFIn.Rg44kU5U.hOBuihn8QdETBIMKSkg953nvU.zym.Q5M7y', 2, NULL),
(42, 'asyatopchik', 'asyatopchik@asyatopchik', '$2y$10$ZZLCGo8ZJzmHmkPK5V8T7evummm6RCcraF0rXELP2DqOp4zj8t7jm', 2, NULL),
(43, 'qqaqaqqaqa', 'qqaqaqqaqa@qqaqaqqaqa', '$2y$10$gnIPtc0GtnS31sjJ96R43.3t6suV/7Xs6j0HWVhtIJvFx60z33L5q', 2, NULL);
...
--
ALTER TABLE `track`
  MODIFY `ID_track` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
